...
class Obra implements Auditable {
    ...
    static constraints = {
        ...
        memoCantidadObra(size: 1..40, blank: true, nullable: true, attributes: [title: 'memoCantidadObra'])
        memoSalida(size: 1..40, blank: true, nullable: true, attributes: [title: 'memoSalida'])
        ...
        memoCertificacionPartida(size: 1..40, blank: true, nullable: true, attributes: [title: 'memoCertificacionPartida'])
        memoActualizacionPrefecto(size: 1..40, blank: true, nullable: true, attributes: [title: 'memoActualizacionPrefecto'])
        memoPartidaPresupuestaria(size: 1..40, blank: true, nullable: true, attributes: [title: 'memoPartidaPresupuestaria'])
        ...
        memoInicioObra(blank: true, nullable: true, maxSize: 40, attributes: [title: 'Memo de inicio de obra'])
        ...
        memoSif(blank: true, maxSize: 40, nullable: true)
