...
<div id="create-baseInstance" class="span" role="main">
    <g:form class="form-horizontal" name="frmSave-baseInstance" action="save">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <g:select id="precioVenta" name="precioVenta.id" from="${janus.Proveedor.list()}" optionKey="id" class="many-to-one " value="${baseInstance?.precioVenta?.id}" noSelection="['null': '']"/>
