    ...
    <table class="table table-bordered table-striped table-condensed table-hover">
        ...
        <g:each in="${tipoContratoInstanceList}" status="i" var="tipoContratoInstance">
            <tr>
                ...
                <td>
                    <a class="btn btn-success btn-xs btn-edit" href="#"  title="Editar" data-id="${tipoContratoInstance.id}">
                        <i class="fa fa-edit"></i>
                    </a>
                    <a class="btn btn-danger btn-xs btn-delete" href="#" title="Eliminar" data-id="${tipoContratoInstance.id}">
