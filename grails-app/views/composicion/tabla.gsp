...
<body>
<div class="hoja">
    <div class="span12 breadcrumb" style="font-size: 18px; margin-bottom: 10px">Valores para la obra: <strong>${obra?.descripcion}</strong> </div>
    ...
    <div class="btn-toolbar" style="margin-top: 15px;">
        ...
        <div class="btn-group" style="margin-left: 40px">
            <g:if test="${(obra?.responsableObra?.departamento?.direccion?.id == persona?.departamento?.direccion?.id &&
                ...
                <a href="#" class="btn recargarComp btn-warning" title="Recargar Composición" id="${obra.id}">
    ...
    <div class="col-md-12" style="margin-bottom: 10px; margin-top: 10px">
        ...
        <div class="col-md-6" style="margin-left: 10px;">
            ...
            <g:textField name="item_nombre" style="font-size: 12px" id="item_nombre" readonly="" class="form-control"/>
        </div>
        ...
        <div class="col-md-1" style="margin-top:35px">
            ...
            <g:if test="${(obra?.responsableObra?.departamento?.direccion?.id == persona?.departamento?.direccion?.id && duenoObra == 1 && obra?.estado != 'R')}">
                ...
                <a href="#" class="btn btn-sm btn-small btn-warning hidden" title="Cancelar" style="margin-top: -25px" id="cancelar">
        ...
        <table class="table table-bordered table-condensed table-hover table-striped" id="tbl">
            ...
            <tr style="width: 100%">
                ...
                <g:elseif test="${tipo.toString() == '[2]'}">
                    <th style="width: 8%">Código</th>
                    <th style="width: 51%">Mano de obra</th>
                    <th style="width: 5%">U</th>
                ...
                <g:if test="${res.size() > 0}">
                    <g:each in="${res}" var="r">
                        <tr style="width: 100%">
                            ...
                            <td style="width: ${tipo.toString() == '[1]' ? 44 : (tipo.toString() == '[2]' ? 51 : 44)} %">${r.item.nombre}</td>
