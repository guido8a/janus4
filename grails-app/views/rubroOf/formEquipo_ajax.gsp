...
<div id="create" class="span" role="main">
    <g:form class="form-horizontal" name="frmSave" action="save_ajax">
        ...
        <div class="form-group keeptogether">
            <div class="col-md-12">
                <span class="grupo">
                    <label for="cantidad" class="col-md-4 control-label">
                        Cantidad
                    </label>
                    <span  class="col-md-8">
                        <g:textField name="cantidad" class="required form-control" value="${detalle?.cantidad}"/>
        ...
        <div class="form-group keeptogether">
            <div class="col-md-12">
                <span class="grupo">
                    <label for="rendimiento" class="col-md-4 control-label">
                        Rendimiento
                    </label>
                    <span  class="col-md-8">
...
<script type="text/javascript">
    ...
    $("#rendimiento, #precio, #cantidad").keydown(function (ev) {
