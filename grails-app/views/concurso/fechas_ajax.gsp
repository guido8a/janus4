            ...
            <div class="row" style="margin-bottom: 5px;">
                <div class="col-md-9 btn-group" role="navigation">
                        <g:if test="${concurso?.estado != 'R'}">
                            <a href="#" class="btn btn-success" id="btnSaveFechasConcurso">
             ...
             <g:form class="form-horizontal" name="frmFechasConcurso" action="saveConcurso_ajax">
                <g:hiddenField name="id" value="${concurso?.id}"/>
                <div class="form-group">
                    <span class="grupo">
                        <label for="fecha1" class="col-md-1 control-label text-info">
                            Publicación
                        </label>
                        <span class="col-md-2">
                    ...
                    <span class="grupo">
                        <label for="fecha3" class="col-md-2 control-label text-info">
                 ...
                 <div class="form-group">
                     <span class="grupo">
                         <label for="fecha6" class="col-md-1 control-label text-info">
                             Adjudicación
                         </label>
                         <span class="col-md-2">
                     ...
                     <span class="grupo">
                         <label for="fecha4" class="col-md-2 control-label text-info">
                 ...
                 <div class="form-group">
                     <span class="grupo">
                         <label for="fecha8" class="col-md-1 control-label text-info">
                             Inicio
                         </label>
                         <span class="col-md-2">
                     ...
                     <span class="grupo">
                         <label for="fecha7" class="col-md-2 control-label text-info">
                             Límite Respuestas
                         </label>
                         <span class="col-md-2">
                 ...
                 <div class="form-group">
                     <span class="grupo">
                         <label for="fecha10" class="col-md-1 control-label text-info">
                             Calificación
                         </label>
                         <span class="col-md-2">
                     ...
                     <span class="grupo">
                         <label for="fecha11" class="col-md-2 control-label text-info">
                             Apertura Ofertas
                         </label>
                         <span class="col-md-2">
                     ...
                     <span class="grupo">
                         <label for="fecha12" class="col-md-2 control-label text-info">
                             Inicio Puja
                         </label>
                         <span class="col-md-2">
                 ...
                 <div class="form-group">
                     <span class="grupo">
                         <label for="fecha14" class="col-md-1 control-label text-info">
                             Fin Puja
                         </label>
                         <span class="col-md-2">
                     ...
                     <span class="grupo">
                         <label for="fecha13" class="col-md-2 control-label text-info">
                     ...
                     <span class="grupo">
                         <label for="fecha15" class="col-md-2 control-label text-info">
...
<script type="text/javascript">
    ...
    $("#btnSaveFechasConcurso").click(function () {
        return submitFormFechasConcurso();
    });

    function submitFormFechasConcurso() {
        var $form = $("#frmFechasConcurso");
        if ($form.valid()) {
