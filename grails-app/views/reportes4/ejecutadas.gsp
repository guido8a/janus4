...
<script type="text/javascript">
    ...
    $("#imprimir").click(function () {
        ...
        location.href="${g.createLink(controller: 'reportes4', action:'reporteEjecutadas' )}?buscador=" + busca + "&operador=" + $("#oprd").val() + "&criterio=" + $("#criterio_con").val()
    });

    $("#excel").click(function () {
        location.href="${g.createLink(controller: 'reportesExcel', action:'reporteExcelEjecutadas' )}?buscador=" + $("#buscador_con").val() + "&criterio=" + $("#criterio_con").val() + "&operador=" + $("#oprd").val()
    });
    ...
    function cargarTabla() {
        ...
        $.ajax({
            type : "POST",
            url : "${g.createLink(controller: 'reportes4', action: 'tablaEjecutadas')}",
            data     : datos,
