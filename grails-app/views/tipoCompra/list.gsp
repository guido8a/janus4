    ...
    <table class="table table-bordered table-striped table-condensed table-hover">
        ...
        <g:each in="${tipoCompraInstanceList}" status="i" var="tipoCompraInstance">
            <tr>
                ...
                <td>
                    <a class="btn btn-success btn-xs btn-edit" href="#"  title="Editar" data-id="${tipoCompraInstance.id}">
                        <i class="fa fa-edit"></i>
                    </a>
                    <a class="btn btn-danger btn-xs btn-delete" href="#" title="Eliminar" data-id="${tipoCompraInstance.id}">
