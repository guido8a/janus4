...
<div id="list-EspecialidadProveedor" class="col-md-6" role="main" style="margin-top: 10px;">
    <table class="table table-bordered table-striped table-condensed table-hover">
        ...
        <g:each in="${especialidadProveedorInstanceList}" status="i" var="especialidadProveedorInstance">
            <tr>
                ...
                <td>
                    <a class="btn btn-success btn-xs btn-edit" href="#"  title="Editar" data-id="${especialidadProveedorInstance.id}">
                        <i class="fa fa-edit"></i>
                    </a>
                    <a class="btn btn-danger btn-xs btn-delete" href="#" title="Eliminar" data-id="${especialidadProveedorInstance.id}">
...
<script type="text/javascript">
        ...
        $.ajax({
            ...
            success : function (msg) {
                var b = bootbox.dialog({
                    id      : "dlgCreateEdit",
                    title   : title + " Especialidad del proveedor",
                    message : msg,
                    buttons : {
                        cancelar : {
                            label     : "Cancelar",
    ...
    function submitFormEP() {
        var $form = $("#frmSave-EspecialidadProveedor");
        if ($form.valid()) {
