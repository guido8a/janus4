...
<div id="list-Direccion" class="span12"  role="main" style="margin-top: 10px;">
    ...
    <table class="table table-bordered table-striped table-condensed table-hover">
        ...
        <g:each in="${direccionInstanceList}" status="i" var="direccionInstance">
            <tr>
                <td>${direccionInstance?.nombre}</td>
                <td>${direccionInstance?.jefatura}</td>
                <td>
                    <a class="btn btn-info btn-xs btn-show" href="#"  title="Ver" data-id="${direccionInstance.id}">
                        <i class="fa fa-clipboard"></i>
                    </a>
                    <a class="btn btn-success btn-xs btn-edit" href="#"  title="Editar" data-id="${direccionInstance.id}">
                        <i class="fa fa-edit"></i>
                    </a>

                    <a class="btn btn-danger btn-xs btn-delete" href="#" title="Eliminar" data-id="${direccionInstance.id}">
...
<elm:pagination total="${direccionInstanceTotal}" params="${params}" />
