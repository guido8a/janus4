...
<g:form class="form-horizontal" name="frmPartida" action="savePartida_ajax">
    ...
    <div class="form-group ${hasErrors(bean: presupuestoInstance, field: 'descripcion', 'error')} ">
        <span class="grupo">
            ...
            <span class="col-md-8">
                <g:textArea name="descripcion" maxlength="255" style="resize: none; height: 100px" class="form-control required" value="${presupuestoInstance?.descripcion}" />
                <p class="help-block ui-helper-hidden"></p>
            </span>
        </span>
    </div>
    ...
    <div class="form-group ${hasErrors(bean: presupuestoInstance, field: 'proyecto', 'error')} ">
        <span class="grupo">
            ...
            <span class="col-md-8">
                <g:textArea name="proyecto" maxlength="255" style="resize: none; height: 100px" class="form-control" value="${presupuestoInstance?.proyecto}" />
                <p class="help-block ui-helper-hidden"></p>
            </span>
        </span>
    </div>
    ...
    <div class="form-group ${hasErrors(bean: presupuestoInstance, field: 'programa', 'error')} ">
        <span class="grupo">
            ...
            <span class="col-md-8">
                <g:textArea name="programa" maxlength="255" style="resize: none; height: 100px" class="form-control" value="${presupuestoInstance?.programa}" />
                <p class="help-block ui-helper-hidden"></p>
            </span>
        </span>
    </div>
    ...
    <div class="form-group ${hasErrors(bean: presupuestoInstance, field: 'subPrograma', 'error')} ">
        <span class="grupo">
            ...
            <span class="col-md-8">
                <g:textArea name="subPrograma" maxlength="255" style="resize: none; height: 100px" class="form-control " value="${presupuestoInstance?.subPrograma}" />
                <p class="help-block ui-helper-hidden"></p>
            </span>
        </span>
    </div>
