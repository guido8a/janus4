    ...
    <table class="table table-bordered table-striped table-condensed table-hover">
        ...
        <g:each in="${unidadIncopInstanceList}" status="i" var="unidadIncopInstance">
            <tr>
                ...
                <td>
                    <a class="btn btn-info btn-xs btn-show" href="#"  title="Ver" data-id="${unidadIncopInstance.id}">
                        <i class="fa fa-clipboard"></i>
                    </a>
                    <a class="btn btn-success btn-xs btn-edit" href="#"  title="Editar" data-id="${unidadIncopInstance.id}">
                        <i class="fa fa-edit"></i>
                    </a>
                    <a class="btn btn-danger btn-xs btn-delete" href="#" title="Eliminar" data-id="${unidadIncopInstance.id}">
