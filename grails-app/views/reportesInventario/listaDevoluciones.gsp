    ...
    <g:each in="${data}" var="dt" status="i">
        <tr>
            ...
            <td style="width: 8%"><div style="text-align: center"
                                       class="seleccionaDev" id="reg_${i}" regId="${dt?.cnsm__id}">
...
<script type="text/javascript">
    $(".seleccionaDev").click(function () {
        var cnsm = $(this).attr("regId");
        location.href = "${g.createLink(controller: 'reportesInventario',action: 'reporteDevoluciones')}?id=" + cnsm
        $("#listaDev").dialog("close")
    });
</script>
